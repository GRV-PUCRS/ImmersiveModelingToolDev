...
public class ALPSController : MonoBehaviour {
	...
	public RenderTexture secondSrcTex;
	...
	public void Awake(){
		...
		//Render Textures
		//srcTex = new RenderTexture (2960, 1440, 16);
		srcTex = gameObject.GetComponent<RenderTextureStore>().srcTexture;
		//secondSrcTex = gameObject.GetComponent<RenderTextureStore>().srcTexture;
		destTex = GetComponent<Camera>().targetTexture;
		cameraRight.GetComponent<Camera>().targetTexture = srcTex;
		cameraLeft.GetComponent<Camera>().targetTexture = srcTex;
	...
	public void OnPostRender(){
		//Graphics.Blit(secondSrcTex, srcTex);
