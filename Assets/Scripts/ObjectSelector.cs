...
public class ObjectSelector : MonoBehaviour
{
    ...
    private void OnTriggerUp()
    {
        ...
        else
        {
            ...
            else // Solta objeto
            {
                ...
                EventManager.TriggerDragEnd(currentObjectHold.GetComponent<DragUI>().TransformToUpdate);
            }
        }
    ...
    private void OnTriggerDown()
    {
        ...
        else
        {
            ...
            {
                otherController.ObjectHold.GetComponent<DragUI>().EndDrag();

                EventManager.TriggerDragEnd(otherController.ObjectHold.GetComponent<DragUI>().TransformToUpdate);
            ...
            else // senao, segue a acao de grab
            {
                ...
                currentObjectHold.gameObject.GetComponent<DragUI>().BeginDrag(objectHolderParent);
                SetLineRendererColor(grabColor);
                SetPointerActive(true);
                pointer.transform.position = hitPoint;

                EventManager.TriggerDragBegin(currentObjectHold.gameObject.GetComponent<DragUI>().TransformToUpdate);
