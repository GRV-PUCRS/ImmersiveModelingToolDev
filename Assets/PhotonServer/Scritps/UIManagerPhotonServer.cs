...
public class UIManagerPhotonServer : Singleton<UIManagerPhotonServer>
{
    ...
    [SerializeField] private TextMeshProUGUI serverPassword;
    ...
    {
        PhotonServerManager.Instance.ChangeConnectionStatus(serverID.text);
    }
    ...
    public void GetServerIDFromUser()
    {
        currentInputText = serverID;
        GetInputFromUser("Insira o ID do Servidor", serverID.text);
    }

    public void GetServerPassword()
    {
        currentInputText = serverPassword;
        GetInputFromUser("Insira a senha do Servidor", serverPassword.text);
    }
    ...
    #region Properties
    public string ServerID { get => serverID.text; set => serverID.text = value; }
    public string ServerPassword { get => serverPassword.text; set => serverPassword.text = value; }
